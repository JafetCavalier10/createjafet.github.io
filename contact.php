...
// Ingrese la dirección de correo electrónico a la que desea enviar correos.
...
// Opción de configuración.
// Por ejemplo, el asunto estándar aparecerá como "Has sido contactado por John Doe".
// Ejemplo: $e_subject = '$name . ' ha contactado con usted a través de su sitio web.'

$e_subject = 'You\'ve been contacted by ' . $first_name . '.';


// Opción de configuración.
// Puedes cambiar esto si lo sientes necesario.
// Desarrolladores, es posible que deseen agregar más campos al formulario, en cuyo caso deben asegurarse de agregarlos aquí.
...
if(mail($address, $e_subject, $msg, $headers)) {
	...
	// El correo electrónico se ha enviado con éxito, muestra una página de éxito.
